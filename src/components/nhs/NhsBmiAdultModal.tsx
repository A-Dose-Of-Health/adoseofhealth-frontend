...
export function NhsBmiAdultModal({
  syndicatorId = "10500",
  buttonLabel = "Calculate BMI (Adults)",
  title = "NHS BMI Calculator (Adults)",
  description = "Calculate your Body Mass Index (BMI) using the official NHS tool.",
}: Props) {
  ...
  return (
    <>
      ...
      <Script
        id="nhsuk-toolsbmit-adult_widget-launcher"
        src="https://www.nhs.uk/health-assessment-tools/calculate-your-body-mass-index/calculate-bmi-for-adults/assets/scripts/widget-launcher.js"
        strategy="afterInteractive"
      />

      {/* Config present in DOM (never unmount) */}
      <script
        id="nhsuk-toolsbmit_widget-config"
