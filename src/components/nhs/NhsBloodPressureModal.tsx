...
export function NhsBloodPressureModal({
  syndicatorId = "10500",
  buttonLabel = "Check blood pressure",
  title = "NHS Blood Pressure Checker",
  description = "Interpret your blood pressure reading using the official NHS tool.",
  isNew = true,
}: Props) {
  ...
  return (
    <>
      ...
      <Script
        id="nhsuk-toolsbpt_widget-launcher"
        src="https://www.nhs.uk/health-assessment-tools/check-your-blood-pressure-reading/scripts/widget-launcher.js"
        strategy="afterInteractive"
      />

      {/* Config present in DOM (never unmount) */}
      <script
        id="nhsuk-toolsbpt_widget-config"
      ...
      {/* ================= Trigger "Card Button" (styled like your snippet) ================= */}
      <button
        type="button"
      ...
      >
        ...
        <div className="relative z-[1] flex items-start justify-between gap-4">
          ...
          {/* Right-side action pill (like play button energy) */}
      ...
      >
        ...
        {/* Modal panel styled like your card */}
              ...
              <div className="relative">
                ...
                <div className="mt-4 flex flex-wrap items-center justify-between gap-3">
                  <a
                    ...
                    href="https://www.nhs.uk/health-assessment-tools/check-your-blood-pressure-reading"
                    target="_blank"
                    rel="noreferrer"
                  >
                    <span className="bg-primary size-1 rounded-full" />
